...
--- we obtain all compounds with a "Treatment related" finding in the "Liver"
...
-- We obtain all CCF Treatmenent related findinds
-- for the compounds "TR" & "Liver" & HPF (tagged 1) (query1)
-- for the other compounds (tagged0)
drop table hptx_ccf_for_hptx_tr;
...
-- for the compounds "TR" & "Liver" & HPF (tagged 1) (query1)
-- for the other compounds (tagged0)
drop table  hptx_hpf_for_hptx_tr;
