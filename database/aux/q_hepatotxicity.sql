...
where 	(x6."relevance" = 'Treatment Related')
 and histopathology_organ_affected like 'Liver'
...
select count(*) from hptx_ccf_for_hptx
drop table hptx_ccf_for_hptx;
create table hptx_ccf_for_hptx as 
select distinct 
	c.subst_id,
	c.smiles,
	c.substance_status,
...
select * from hptx_ccf_for_hptx


select count(*) from hptx_hpf_for_hptx
select * from hptx_hpf_for_hptx
drop table hptx_hpf_for_hptx;
create table hptx_hpf_for_hptx as 
select distinct
	c.subst_id,
	c.smiles,
	c.substance_status,
